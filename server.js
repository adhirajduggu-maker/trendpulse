...
function looksLikeProductTitle(t=""){
 ...
 if(/shop by|browse|category|customer service|account|login|sign in|cart|wishlist|footer|header/i.test(s))return false;
 return true;
}
...
app.get("/api/health",(q,r)=>r.json({ok:true,version:"2.5",countryAware:true,productSources:{IN:["Amazon India","Flipkart","Meesho"],US:["Amazon US","eBay US","Walmart"],GB:["Amazon UK","eBay UK","Argos"],CA:["Amazon Canada","eBay Canada","Walmart Canada"],AU:["Amazon AU","eBay AU"]},videoSources:["YouTube","Instagram","Facebook"]}));
...
app.listen(PORT,()=>console.log(`TrendPulse V2.5 running on ${PORT}`));
