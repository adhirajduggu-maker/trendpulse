...
function showAgentError(msg){
 $("#agentCards").innerHTML=`<div class="agent-error"><b>Agent could not complete this request.</b><p>${E(msg)}</p><button id="retryInside">Retry agent</button></div>`;
 setTimeout(()=>{const b=$("#retryInside");if(b)b.onclick=()=>run($("#rerunAgent"));},0);
}
