...
function visualFor(t){
  ...
  let icon="↗", cls="visual-search";
  if(type==="product"){icon="◇";cls="visual-product"}
  if(type==="video"){icon="▶";cls="visual-video"}
  if(src.includes("youtube")){icon="▶";cls="visual-youtube"}
  if(src.includes("instagram")){icon="◎";cls="visual-instagram"}
  if(src.includes("amazon")){icon="a";cls="visual-amazon"}
  return `<div class="card-visual ${cls}"><span>${icon}</span></div>`;
}
